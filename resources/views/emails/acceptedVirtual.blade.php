...
<table width="100%" border="0" cellspacing="0" cellpadding="0"
       style="background-image: url('https://drive.google.com/uc?export=view&id=1Ci22_8PD-9i7kmKaFVvWdvgb7b6R-F5y'); background-size: cover; background-position: center; width: 100%; padding: 40px 0; background-repeat: no-repeat;">
    <tr>
        <td align="center">
            <!-- Main Container -->
            <table width="600" border="0" cellspacing="0" cellpadding="0" bgcolor="#f3ffff"
                ...
                <tr>
                    <td align="center" style="background-color: #f3ffff; padding: 10px 10px 0 10px;">
                        <img src="https://scontent.fcai19-12.fna.fbcdn.net/v/t39.30808-6/456507356_949220880572543_1010168927811415993_n.jpg?_nc_cat=105&ccb=1-7&_nc_sid=cc71e4&_nc_ohc=IkRQuSVeVIEQ7kNvgFZ57F0&_nc_ht=scontent.fcai19-12.fna&_nc_gid=As4VbV37omPp027XR6a3iQx&oh=00_AYANXeJ_9Cv2MkNm8XX6S_0QqSdY32mtwbnn0iE_JtAV9A&oe=6700F4FB"
                ...
                <tr>
                    <td
                        ...
                        <p
                            ...
                            We are pleased to invite you to participate in the <strong>Virtual Version</strong> of <strong>NASA Space Apps Cairo 2024!</strong>
                            ...
                            <tr>
                                <td
                                    ...
                                    <p style="font-size: 14px; margin: 5px 0; color: #f3ffff;">
                                        <strong>Date:</strong> <em>Friday and Saturday, October 4th and 5th</em></p>
                                    <p style="font-size: 14px; margin: 5px 0; color: #f3ffff;">
                                        <strong>Location:</strong> <em>Virtual</em></p>
                                </td>
                            </tr>
                        </table>
                    </td>
                        ...
                        <table style="margin-right: auto; margin-left: auto; min-width:60%;" border="0"
                            ...
                            <tr>
                                <td
                                    ...
                                    <p style="font-size: 14px; margin: 5px 0; color: #f3ffff;">
                                        <strong>Deadline:</strong> <em>Wednesday, October 2, at 11:59 PM</em></p>
                                    <p style="font-size: 14px; margin: 5px 0; color: #f3ffff;">
                                        <strong>Form Link:</strong> <a
                                            href="https://bit.ly/NASA2024-Virtual"
                                            style="color: #f3ffff; text-decoration: underline"><em>
                                                https://bit.ly/NASA2024-Virtual</em></p>
                                </td>
                            </tr>
                        </table>
                    </td>
