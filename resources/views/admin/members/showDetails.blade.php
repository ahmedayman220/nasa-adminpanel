...
<div class="card">
    <div class="card-header">
        {{ trans('global.show') }} <strong>{{ $member->name }}</strong> Details
    </div>
    @can('personal_details')
    <div class="card-body">
        <div class="form-group">
            <div class="form-group">
                <a class="btn btn-default" href="{{ route('admin.members.showDetailsScan') }}">
