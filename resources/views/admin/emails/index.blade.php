                ...
                <tr>
                    ...
                    <td>
                        <select class="search" strict="true">
                            <option value>{{ trans('global.all') }}</option>
                            @foreach(App\Models\Email::STATUS_SELECT as $key => $item)
...
{ data: 'id', name: 'id' },
{ data: 'qrcode_qr_code_value', name: 'qrcode.qr_code_value' },
{ data: 'status', name: 'status' },
{ data: 'bootcamp_participant_email_email', name: 'bootcamp_participant_email.email' },
