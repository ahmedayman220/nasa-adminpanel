...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.bootcampParticipant.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.bootcamp-participants.update", [$bootcampParticipant->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="name_en">{{ trans('cruds.bootcampParticipant.fields.name_en') }}</label>
                <input class="form-control {{ $errors->has('name_en') ? 'is-invalid' : '' }}" type="text" name="name_en" id="name_en" value="{{ old('name_en', $bootcampParticipant->name_en) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name_ar') ? 'is-invalid' : '' }}" type="text" name="name_ar" id="name_ar" value="{{ old('name_ar', $bootcampParticipant->name_ar) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $bootcampParticipant->email) }}" required>
                @if($errors->has('email'))
                    <div class="invalid-feedback">
                        {{ $errors->first('email') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('age') ? 'is-invalid' : '' }}" type="text" name="age" id="age" value="{{ old('age', $bootcampParticipant->age) }}" required>
                @if($errors->has('age'))
                    <div class="invalid-feedback">
                        {{ $errors->first('age') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone_number') ? 'is-invalid' : '' }}" type="text" name="phone_number" id="phone_number" value="{{ old('phone_number', $bootcampParticipant->phone_number) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('educational_level') ? 'is-invalid' : '' }}" name="educational_level_id" id="educational_level_id" required>
                    @foreach($educational_levels as $id => $entry)
                        <option value="{{ $id }}" {{ (old('educational_level_id') ? old('educational_level_id') : $bootcampParticipant->educational_level->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('field_of_study') ? 'is-invalid' : '' }}" name="field_of_study_id" id="field_of_study_id" required>
                    @foreach($field_of_studies as $id => $entry)
                        <option value="{{ $id }}" {{ (old('field_of_study_id') ? old('field_of_study_id') : $bootcampParticipant->field_of_study->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('educational_institute') ? 'is-invalid' : '' }}" type="text" name="educational_institute" id="educational_institute" value="{{ old('educational_institute', $bootcampParticipant->educational_institute) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('graduation_year') ? 'is-invalid' : '' }}" type="text" name="graduation_year" id="graduation_year" value="{{ old('graduation_year', $bootcampParticipant->graduation_year) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('position') ? 'is-invalid' : '' }}" type="text" name="position" id="position" value="{{ old('position', $bootcampParticipant->position) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('national') ? 'is-invalid' : '' }}" type="text" name="national" id="national" value="{{ old('national', $bootcampParticipant->national) }}" required>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\BootcampParticipant::IS_PARTICIPATED_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('is_participated') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="is_participated_{{ $key }}" name="is_participated" value="{{ $key }}" {{ old('is_participated', $bootcampParticipant->is_participated) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('participated_year') ? 'is-invalid' : '' }}" type="text" name="participated_year" id="participated_year" value="{{ old('participated_year', $bootcampParticipant->participated_year) }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\BootcampParticipant::IS_ATTEND_FORMATION_ACTIVITY_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('is_attend_formation_activity') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="is_attend_formation_activity_{{ $key }}" name="is_attend_formation_activity" value="{{ $key }}" {{ old('is_attend_formation_activity', $bootcampParticipant->is_attend_formation_activity) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('first_priority') ? 'is-invalid' : '' }}" name="first_priority_id" id="first_priority_id" required>
                    @foreach($first_priorities as $id => $entry)
                        <option value="{{ $id }}" {{ (old('first_priority_id') ? old('first_priority_id') : $bootcampParticipant->first_priority->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('second_priority') ? 'is-invalid' : '' }}" name="second_priority_id" id="second_priority_id">
                    @foreach($second_priorities as $id => $entry)
                        <option value="{{ $id }}" {{ (old('second_priority_id') ? old('second_priority_id') : $bootcampParticipant->second_priority->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('third_priority') ? 'is-invalid' : '' }}" name="third_priority_id" id="third_priority_id">
                    @foreach($third_priorities as $id => $entry)
                        <option value="{{ $id }}" {{ (old('third_priority_id') ? old('third_priority_id') : $bootcampParticipant->third_priority->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('why_this_workshop') ? 'is-invalid' : '' }}" type="text" name="why_this_workshop" id="why_this_workshop" value="{{ old('why_this_workshop', $bootcampParticipant->why_this_workshop) }}" required>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\BootcampParticipant::IS_HAVE_TEAM_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('is_have_team') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="is_have_team_{{ $key }}" name="is_have_team" value="{{ $key }}" {{ old('is_have_team', $bootcampParticipant->is_have_team) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('comment') ? 'is-invalid' : '' }}" type="text" name="comment" id="comment" value="{{ old('comment', $bootcampParticipant->comment) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('year') ? 'is-invalid' : '' }}" type="text" name="year" id="year" value="{{ old('year', $bootcampParticipant->year) }}" required>
                @if($errors->has('year'))
                    <div class="invalid-feedback">
                        {{ $errors->first('year') }}
                    </div>
