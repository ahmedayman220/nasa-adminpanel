        ...
        <div class="card-body">
            <table class="table table-bordered table-striped table-hover ajaxTable datatable datatable-Team">
                ...
                <tr>
                    ...
                    <th>
                        {{ trans('cruds.team.fields.actual_solution') }} (Final Solution)
                    </th>
                    <th>
                        {{ 'Comments' }}
                    </th>
    ...
    <script>
        $(function () {
            ...
            let dtOverrideGlobals = {
                ...
                columns: [
                    { data: 'placeholder', name: 'placeholder' }, // Select
                    { data: 'actions', name: '{{ trans('global.actions') }}' }, // View
                    { data: 'change_status', name: 'change_status' }, // Change Status
                    { data: 'id', name: 'id' }, // ID
                    { data: 'team_name', name: 'team_name' }, // Team Name
                    { data: 'challenge_title', name: 'challenge.title' }, // Challenge
                    { data: 'project_video_url', name: 'project_video_url' }, // Project Video URL
                    { data: 'actual_solution_title', name: 'actual_solution.title' }, // Final Solution
                    { data: 'comments', name: 'comments' }, // Comments
                    { data: 'total_score', name: 'total_score' }, // Total Score
                    { data: 'status', name: 'status' }, // Status
                ],
                orderCellsTop: true,
                order: [[ 3, 'desc' ]], // Order by ID column
                pageLength: 100,
            };
