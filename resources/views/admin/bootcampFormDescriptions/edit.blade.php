...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.bootcampFormDescription.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.bootcamp-form-descriptions.update", [$bootcampFormDescription->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="section_1_title">{{ trans('cruds.bootcampFormDescription.fields.section_1_title') }}</label>
                <input class="form-control {{ $errors->has('section_1_title') ? 'is-invalid' : '' }}" type="text" name="section_1_title" id="section_1_title" value="{{ old('section_1_title', $bootcampFormDescription->section_1_title) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('section_1_description') ? 'is-invalid' : '' }}" name="section_1_description" id="section_1_description">{!! old('section_1_description', $bootcampFormDescription->section_1_description) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('national_id_front_description') ? 'is-invalid' : '' }}" name="national_id_front_description" id="national_id_front_description">{{ old('national_id_front_description', $bootcampFormDescription->national_id_front_description) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('national_id_back_description') ? 'is-invalid' : '' }}" name="national_id_back_description" id="national_id_back_description">{{ old('national_id_back_description', $bootcampFormDescription->national_id_back_description) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('section_2_title') ? 'is-invalid' : '' }}" type="text" name="section_2_title" id="section_2_title" value="{{ old('section_2_title', $bootcampFormDescription->section_2_title) }}">
