...
@can('participant_workshop_preference_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            ...
            @include('csvImport.modal', ['model' => 'ParticipantWorkshopPreference', 'route' => 'admin.participant-workshop-preferences.parseCsvImport'])
        </div>
    </div>
@endcan
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-ParticipantWorkshopPreference">
            <thead>
                <tr>
                    <th width="10">
                ...
                <tr>
                    ...
                    <td>
                        <select class="search" strict="true">
                            <option value>{{ trans('global.all') }}</option>
                            @foreach(App\Models\ParticipantWorkshopPreference::PREFERENCE_ORDER_SELECT as $key => $item)
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-ParticipantWorkshopPreference').DataTable(dtOverrideGlobals);
